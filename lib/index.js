 ...
 * @param {updatePlayerPositionCallback} next - The callback to be executed after the update. 
 */
 ...
 *
 * @callback updatePlayerPositionCallback
 ...
 * @param {command} The command object
 * @param {number} whether to send output
 */
...
advtxt.Server.prototype.doCommand = function(command) {
	...
	else if (verb === i18n.__('reset') && typeof obj === 'undefined') {
